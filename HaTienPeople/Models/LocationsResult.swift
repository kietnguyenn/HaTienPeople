...
struct LocationsResult: Codable {
    ...
    let executedTime, executedTimeAll: Int?
    let status: String?

    enum CodingKeys: String, CodingKey {
        case predictions
        case executedTime = "executed_time"
        case executedTimeAll = "executed_time_all"
        case status
    }
}
...
//
//   let task = URLSession.shared.predictionTask(with: url) { prediction, response, error in
...
struct StructuredFormatting: Codable {
    let mainText, secondaryText: String?
...
struct PlaceDetailResult: Codable {
    let placeID, formattedAddress: String?
